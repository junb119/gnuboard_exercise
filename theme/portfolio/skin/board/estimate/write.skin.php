...
<section id="bo_w">
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper" class="write_div">
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="100" placeholder="연락처">
        </div>
    </div>
    <div class="bo_w_tit write_div">
        <label for="wr_2" class="sound_only">예산</label>
        <div id="autosave_wrapper" class="write_div">
            <input type="number" min="100" step="100" max="1000" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input  required" size="20" maxlength="50" placeholder="예산" >만원
        </div>
    </div>
    <div class="bo_w_tit write_div">
        <label for="wr_3" class="sound_only">모델사이트</label>
        <div id="autosave_wrapper" class="write_div">
            <input type="url" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" required class="frm_input full_input required" size="20" maxlength="50" placeholder="모델사이트">
        </div>
    </div>
